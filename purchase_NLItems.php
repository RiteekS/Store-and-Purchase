...
<form action="purchase_NLItems.php" method="post" name="frm">
  <fieldset>
   ...
   <br><br>
    ...
    Online Store URL<br>
    <input name="URL" required ="required" type="text"  pattern = "/^(http|https|ftp):\/\/([A-Z0-9][A-Z0-9_-]*(?:\.[A-Z0-9][A-Z0-9_-]*)+):?(\d+)?\/?/i"  size="40" /><br>
    Item Details<br>
    <input name="itemDetails" required="required" type= "text"size="40" /><br>
    Price<br>
    <input  name="itemPrice" required="required" type= "float" pattern ="^[0-9]*$" size="40" /><br>
    Quantity<br>
