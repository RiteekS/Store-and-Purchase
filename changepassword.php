...
<form action="changepassword.php" method="post" name="frm">
      ...
      <h3>New Password</h3>
      <input required = "required"name="npswrd" type="password" pattern = "[A-Za-z][A-Za-z0-9]*" size="6" />
      <h3>Confirm Password</h3>
      <input required = "required" name="cpswrd" type="password" pattern = "[A-Za-z][A-Za-z0-9]*" size="6" />
